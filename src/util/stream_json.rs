...
//! - https://stackoverflow.com/a/68643171

use serde::de::DeserializeOwned;
use serde_json::{self, Deserializer};
use std::io::{self, Read};

/// Reads bytes from a reader until a non-whitespace byte is found, this byte then is returned
...
/// Returns a serde errpr about invalid data
fn invalid_data(msg: &str) -> io::Error {
    io::Error::new(io::ErrorKind::InvalidData, msg)
}

/// Deserialize a single item [`T`] from a reader
...
/// Create an iterator for a reader, assuming a JSON file with a top-level array
pub(super) fn iter_json_array<T: DeserializeOwned, R: Read>(
    mut reader: R,
